...
const Contacts = () => {
  return (
    <section
      id="contact"
      className="bg-gradient-to-r from-blue-500 to-blue-700 min-h-screen flex flex-col items-center justify-center text-center py-4 overflow-hidden" // Adjusted py-4
    >
